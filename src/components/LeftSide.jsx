...
function LeftSide({ dataset }) {
  ...
  const showDailyChart = (pollutantName) => {
    console.log("RESULT", pollutantName, data);
    const { date } = data;
    console.log("date leftside", date);
      ...
      <div className="pt-3">
        ...
        <div className="gap-4 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 py-3">
          {[
            {
              label: "Wind Speed",
              value: `${data.wind_speed.toFixed(2)} kmph`,
            ...
            },
            {
              ...
              value: data.sea_level_pressure.toFixed(2),
              icon: "icons/pressure.png",
              chart: "sea_level_pressure",
            },
            {
              label: "UV Index",
              value: `${data.uv_index.toFixed(2)} mJ/cm²`,
              icon: "icons/sunrise.png",
              chart: "uv_index",
            },
            {
              label: "Gust",
              value: `${data.wind_gust.toFixed(2)} kmph`,
              icon: "icons/windy.png",
              chart: "wind_gust",
            },
            {
